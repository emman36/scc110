public class Collissions {
    public static double[] deflect(double xPosition1, double xPosition2, double yPosition1, double yPosition2, double xSpeed1, double xSpeed2, double ySpeed1, double ySpeed2)
 {
 ...
 return(new double[]{xSpeed1, ySpeed1, xSpeed2, ySpeed2});
 }
 /**
